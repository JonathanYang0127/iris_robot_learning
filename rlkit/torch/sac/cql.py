...
class CQLTrainer(TorchTrainer):
    ...
    def _get_policy_actions(self, obs, num_actions, network=None):
        ...
        new_obs_dist = network(obs_temp)
        # new_obs_actions, _, _, new_obs_log_pi, *_ = network(
        #     obs_temp, reparameterize=True, return_log_prob=True,
        # )
        new_obs_actions, new_obs_log_pi = new_obs_dist.rsample_and_logprob()
    ...
    def train_from_torch(self, batch):
        ...
        policy_mean, policy_log_std = dist.mean, torch.log(dist.normal_std)
        ...
        new_curr_actions, new_curr_log_pi = new_dist.rsample_and_logprob()
