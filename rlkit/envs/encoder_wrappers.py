...
class DuelEncoderWrappedEnv(ProxyEnv):
    def __init__(self,
        wrapped_env,
        model: Encoder,
        input_model,
...
# class DuelConditionalEncoderWrappedEnv(ProxyEnv):
#     def __init__(self,
#         wrapped_env,
#         model: ConditionalEncoder,
#         reward_model,
...
#         if self.conditional_input_model:
#             obs['reward_latent'] = self.reward_model.encode_one_np(obs['image_observation'], self._initial_img)
#         else:
#             obs['reward_latent'] = self.reward_model.encode_one_np(obs['image_observation'])
