...
if __name__ == '__main__':
    ...
    search_space = {
        ...
        'create_vae_kwargs.encoder_mlp_kwargs.hidden_sizes': [
            [],
            [128],
            [128, 128],
        ]
    ...
    for exp_id, variant in enumerate(sweeper.iterate_hyperparameters()):
        ...
        n_channels = str(variant['create_vae_kwargs']['encoder_cnn_kwargs']['n_channels'])[1:-1]
        mlp_hs = str(variant['create_vae_kwargs']['encoder_mlp_kwargs']['hidden_sizes'])[1:-1]
        for _ in range(n_seeds):
            variant['logger_config'] = dict(
                trial_dir_suffix='beta-{}-ks{}-mlp{}'.format(
                    beta,
                    n_channels,
                    mlp_hs,
                )
