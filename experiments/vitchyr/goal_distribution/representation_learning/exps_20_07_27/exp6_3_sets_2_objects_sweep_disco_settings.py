...
if __name__ == "__main__":
    variant = dict(
        ...
        generate_set_for_rl_kwargs=dict(
            ...
            saved_filename='3sets128samples_2objs.pickle',
        ),
    ...
    n_seeds = 3
    mode = 'sss'
    exp_prefix = '20-07-27-exp6-3-sets-2-objects-sweep-disco-settings'
    ...
    search_space = {
        ...
        'reward_fn_kwargs.drop_log_det_term': [
            True,
            False,
        ],
        'reward_fn_kwargs.sqrt_reward': [
            True,
            False,
        ],
    ...
    for _ in range(n_seeds):
        for exp_id, variant in enumerate(variants):
            if (
                    not variant['reward_fn_kwargs']['drop_log_det_term']
                    and variant['reward_fn_kwargs']['sqrt_reward']
            ):
                continue
            run_experiment(
                disco_experiment,
