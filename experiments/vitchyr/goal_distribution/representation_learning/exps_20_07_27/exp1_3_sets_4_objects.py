...
if __name__ == "__main__":
    variant = dict(
        ...
        generate_set_for_rl_kwargs=dict(
            num_sets=3,
            num_samples_per_set=128,
            # save_to_filename='3sets128samples_4objs.pickle',
            saved_filename='3sets128samples_4objs.pickle',
        ),
    ...
    n_seeds = 3
    mode = 'sss'
    exp_prefix = '20-07-27-exp1-3-sets-4-objects'
    ...
    search_space = {
        ...
        'rig_goal_setter_kwargs.use_random_goal': [
            True,
            False,
        ],
    ...
    for _ in range(n_seeds):
        for exp_id, variant in enumerate(variants):
            if (
                    not variant['rig']
                    and variant['rig_goal_setter_kwargs']['use_random_goal']
            ):
                continue
            run_experiment(
                disco_experiment,
