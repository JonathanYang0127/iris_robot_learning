...
if __name__ == "__main__":
    variant = dict(
        ...
        generate_set_for_rl_kwargs=dict(
            num_sets=9,
            num_samples_per_set=128,
            # save_to_filename='9sets128samples_xy_x_y.pickle',
            saved_filename='6sets128samples_xy_x_y.pickle',
        ),
    ...
    n_seeds = 3
    mode = 'sss'
    exp_prefix = '20-07-27-exp2-6-or-9-sets-grab-radius-1-rig-random-goal-take2'
