...
if __name__ == "__main__":
    ...
    n_seeds = 3
    mode = 'sss'
    exp_prefix = '20-07-25-exp5-single-set-new-settings'
    ...
    search_space = {
        ...
        'reward_fn_kwargs.use_proper_scale_diag': [
            True,
            False,
        ],
    }
    ...
    for _ in range(n_seeds):
        for exp_id, variant in enumerate(variants):
            if (variant['reward_fn_kwargs']['drop_log_det_term']
                    and variant['reward_fn_kwargs']['use_proper_scale_diag']):
                continue
