...
if __name__ == "__main__":
    variant = dict(
        ...
        generate_set_for_rl_kwargs=dict(
            num_sets=4,
            num_samples_per_set=128,
            # save_to_filename='4sets128samples.pickle',
            saved_filename='4sets128samples.pickle',
        ),
    ...
    n_seeds = 3
    mode = 'sss'
    exp_prefix = '20-07-25-exp8-four-sets-grab-radius-1-without-log-det'

    search_space = {
        # 'vae_algo_kwargs.num_iters': [20],
