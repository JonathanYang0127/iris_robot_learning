...
if __name__ == "__main__":
    ...
    search_space = {
        'env_id': [
            'HopperFullPositionGoal-Forward-v0',
            'HopperFullPositionGoal-Forward-v1',
        ],
    ...
    n_seeds = 4
    mode = 'htp'
    exp_name = 'pgr--hopper--exp-2--sweep-rewards-take2'
    ...
    for exp_id, variant in enumerate(sweeper.iterate_hyperparameters()):
        if (
            ...
            and variant['dynamics_model_version'] != 'learned_model_laplace'
        ):
            continue
        if 'output_activations' in variant['dynamics_model_config']:
            variant['dynamics_delta_model_config'] = dict(
    ...
    n_seeds = 4
    mode = 'htp'
    exp_name = 'pgr--hopper--exp-2--sweep-rewards-sweep-floored-model'
