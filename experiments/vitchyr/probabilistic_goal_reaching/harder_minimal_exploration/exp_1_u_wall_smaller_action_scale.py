...
if __name__ == "__main__":
    variant = dict(
        ...
        eval_env_ids={
            'hard_init': 'Point2D-Easy-UWall-Hard-Init-ActionScale0p1-v1',
            'random_init': 'Point2D-Easy-UWall-ActionScale0p1-v1',
        },
    ...
    search_space = {
        'env_id': [
            'Point2D-Easy-UWall-ActionScale0p1-v1',
            'Point2D-Easy-UWall-Hard-Init-ActionScale0p1-v1',
        ],
    ...
    n_seeds = 1
    mode = 'ec2'
    exp_name = 'pgr--harder-minimal-exploration--exp-1-u-wall-small-action-scale-take4-ec2'
