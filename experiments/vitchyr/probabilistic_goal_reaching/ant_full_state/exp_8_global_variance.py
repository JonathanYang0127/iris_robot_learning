...
if __name__ == "__main__":
    variant = dict(
        ...
        pgr_trainer_kwargs=dict(
            ...
            prior_discount_weight_drop_rate=0.01,
            initial_weight_on_prior_discount=1.0,
        ),
    ...
    n_seeds = 4
    mode = 'htp'
    exp_name = 'pgr--ant-full-state--exp-8--global-variance'
    ...
    if mode == 'local':
        ...
        variant['pgr_trainer_kwargs']['prior_discount_weight_drop_rate'] = 0.5
