...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'discount_model_config.hidden_sizes': [
            [],
            [8],
            [16],
            [64],
    ...
    n_seeds = 2
    mode = 'htp'
    exp_name = 'pgr--basic-reaching--exp-16--u-wall-neg-distance-with-learned-discount'
    ...
    if mode == 'local':
        ...
        # )
        variant['algo_kwargs']['num_epochs'] = 10
