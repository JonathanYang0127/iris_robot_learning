...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'env_id': [
            'FiveObjectPickAndPlaceRandomInit2DEnv-v0',
            'FourObjectPickAndPlaceRandomInit2DEnv-v0',
            'ThreeObjectPickAndPlaceRandomInit2DEnv-v0',
    ...
    n_seeds = 1
    mode = 'sss'
    exp_name = 'n_object_pnp--sweep-env-ball-radius-1'
