...
def main(debug, dry, suffix, nseeds, mode, olddd):
    ...
    def run_sweep(variant):
        search_space = {
            'load_buffer_kwargs.pretrain_buffer_path': [
                # "/preloaded_data2/21-02-22-ant-awac--exp7-ant-dir-4-eval-4-train-sac-to-get-buffer-longer/21-02-22-ant-awac--exp7-ant-dir-4-eval-4-train-sac-to-get-buffer-longer_2021_02_23_06_09_23_id000--s270987/extra_snapshot_itr400.cpkl"
                "/preloaded_data/21-05-05_pearl-awac-ant-awac--exp58-ant-dir-120-online-pearl/16h-03m-09s_run2/extra_snapshot_itr100.cpkl"
            ],
            'saved_tasks_path': [
                "/preloaded_data/21-05-05_pearl-awac-ant-awac--exp58-ant-dir-120-online-pearl/16h-03m-09s_run2/tasks_description.joblib"
            ],
    ...
    configs = [
        ...
        base_dir / 'configs/ant_dir_120_offline_pearl_buffer.conf',
    ]
    if debug:
