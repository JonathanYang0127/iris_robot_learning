...
def main(debug, dry, suffix, nseeds):
    ...
    def run_sweep(search_space, variant, xid):
        for k, v in {
            ...
            # Note: this variable was renamed to `clear_encoder_buffer_before_every_update`
            # but it shouldn't affect this experiment
            'algo_kwargs.clear_encoder_buffer_every_iteration': [
                False,
            ],
