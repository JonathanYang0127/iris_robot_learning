...
if __name__ == '__main__':  # NOQA
    default_variant = dict(
        ...
        # 'presampled_images',#'presample_latents',
    ...
    for variant in sweeper.iterate_hyperparameters():
        ...
        variant['online_offline_split_replay_buffer_kwargs']['online_replay_buffer_kwargs']['max_size'] = min(int(
            4/6 * 500*75*variant['num_demos']), int(1E6 - variant['online_offline_split_replay_buffer_kwargs']['offline_replay_buffer_kwargs']['max_size']))
