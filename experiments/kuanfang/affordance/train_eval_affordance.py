...
from rlkit.experimental.kuanfang.vae.affordance_trainer import AffordanceTrainer  # NOQA
...
def train_eval(
    ...
    # discriminator = affordance_networks.Discriminator(
    #     data_channels=embedding_dim,
    # ).to(ptu.device)
    ...
    datasets = io_util.load_datasets(
        ...
        dataset_ctor=vae_datasets.VaeContrastiveGoalDataset,
        vqvae_mode='zq',
        transform=None,
        crop=[48, 48],
        delta_t=delta_t,
