...
from rlkit.torch.vae.biva.model.deepvae import BIVA
from rlkit.torch.vae.biva_trainer import BIVATrainer
...
if __name__ == "__main__":
    variant = dict(
        ...
        train_vae_variant=dict(
            ...
            generate_vae_dataset_kwargs=dict(
                ...
                n_random_steps=2,
                test_p=.9,
                dataset_path='demos/corl2020/data/4dof_complex_objects_images.npy',
    ...
    run_variants(grill_her_td3_offpolicy_online_vae_full_experiment, variants, run_id=11)
