...
flags.DEFINE_multi_string('gin_file', "experiments/ashvin/awacp/tfcql/antmaze.gin", 'Paths to the gin-config files.')
...
def train_eval(
  ...
  root_dir = "%s/%s/%s/%s/" % (root_dir, exp_name, env_name, str(seed))
...
def main(env_name, exp_name, seedid):
  logging.set_verbosity(logging.INFO)

  gin.parse_config_files_and_bindings("experiments/ashvin/awacp/tfcql/antmaze.gin", None)
