...
if __name__ == "__main__":
    variant = dict(
        ...
        path_loader_kwargs=dict(
            ...
            demo_paths=[
                dict(
                    path="demos/icml2020/hand/door2.npy",
                    obs_dict=True,
                    is_demo=True,
                ),
                dict(
    ...
    search_space = {
        ...
        'trainer_kwargs.reparam_weight': [1e-1, 1e-2, 1e-3, 1e-4, 0],
        # 'trainer_kwargs.policy_weight_decay': [1e-3],
    }
