...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'trainer_kwargs.beta_schedule_kwargs': [
            dict(x_values=(25000, 250000), y_values=(100, 50)),
            dict(x_values=(25000, 250000), y_values=(100, 30)),
            dict(x_values=(25000, 250000), y_values=(100, 10)),
            dict(x_values=(25000, 500000), y_values=(100, 50)),
            dict(x_values=(25000, 500000), y_values=(100, 30)),
            dict(x_values=(25000, 500000), y_values=(100, 10)),
        ],
    }
