...
if __name__ == "__main__":
    variant = dict(
        ...
        pretrained_algorithm_path="ashvin/icml2020/hand/pen/gaussian/bc6/run14/id0/pretrain_algorithm.pt",
    )
    ...
    search_space = {
        ...
        'trainer_kwargs.post_pretrain_hyperparams.reparam_weight': [1e-5, 3e-6, 1e-6, 3e-7],
    }
