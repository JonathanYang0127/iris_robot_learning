...
if __name__ == "__main__":
    variant = dict(
        ...
        pretrained_algorithm_path="ashvin/icml2020/hand/pen/gaussian/test1/run11/id0/pretrain_algorithm.pt",
    )
    ...
    search_space = {
        ...
        'trainer_kwargs.post_pretrain_hyperparams.awr_weight': [100000.0, 300000.0, 1000000.0],
    }
