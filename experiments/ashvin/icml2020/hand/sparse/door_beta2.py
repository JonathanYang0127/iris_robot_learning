...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'policy_kwargs.std_architecture': ["shared"],
        ...
        'trainer_kwargs.beta_schedule_kwargs': [
            dict(x_values=[250000, 1000000], y_values=[0.3, 0.3]),
            dict(x_values=[250000, 1000000], y_values=[0.3, 1]),
            dict(x_values=[250000, 1000000], y_values=[0.3, 3]),
            dict(x_values=[250000, 500000], y_values=[0.3, 1]),
            dict(x_values=[250000, 500000], y_values=[0.3, 3]),
        ],
    }
