...
if __name__ == "__main__":
    variant = dict(
        ...
        buffer_policy_class=GaussianMixturePolicy,
    ...
    search_space = {
        ...
        'seedid': range(3),
        'trainer_kwargs.beta': [10.0, 30.0, 100.0],
        ...
        # 'policy_kwargs.num_gaussians': [2, ],
        'trainer_kwargs.use_klac_update':[True],
        'trainer_kwargs.use_awr_update':[False],
        'trainer_kwargs.klac_weight': [1.0, ],
        'trainer_kwargs.klac_weight': [10, 50, ],
    }
