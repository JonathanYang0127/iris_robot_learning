...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'env': [
            "halfcheetah-random-v0", "halfcheetah-medium-v0", "halfcheetah-expert-v0", "halfcheetah-medium-expert-v0",
            "walker2d-random-v0", "walker2d-medium-v0", "walker2d-expert-v0", "walker2d-medium-expert-v0",
            "hopper-random-v0", "hopper-medium-v0", "hopper-expert-v0", "hopper-medium-expert-v0"
        ],
        'trainer_kwargs.bc_loss_type': ["mle"],
        'trainer_kwargs.awr_loss_type': ["mle"],
        'seedid': range(3),
        'trainer_kwargs.beta': [1e-1, 1e-3, 1e-5],
