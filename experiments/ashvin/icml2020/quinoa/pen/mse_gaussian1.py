...
from rlkit.torch.sac.policies import GaussianPolicy, GaussianMixturePolicy, BinnedGMMPolicy
...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'trainer_kwargs.buffer_for_bc_training': ["demos", "replay_buffer", ],
