...
from rlkit.data_management.online_vae_replay_buffer import OnlineConditionalVaeRelabelingBuffer
...
if __name__ == "__main__":
    variant = dict(
        ...
        grill_variant=dict(
            ...
            # vae_path="models/standard_vae.pkl", # "/home/khazatsky/rail/data/rail-khazatsky/sasha/PCVAE/PCVAE/run1/id0/itr_1300.pkl",
            vae_path="sasha/PCVAE/PCVAE/run1/id0/itr_1400.pkl",
    ...
    search_space = {
        'seedid': range(5),
        'grill_variant.reward_params.type':['latent_distance', ], # 'success_prob', 'log_success_prob'],
