...
if __name__ == "__main__":
    variant = dict(
        ...
        grill_variant=dict(
            ...
            algo_kwargs=dict(
                ...
                dataset_path="datasets/Multiobj2DEnv_N100000_sawyer_pusher_camera_upright_v2_imsize48_random_oracle_split_0offpolicy2.npy",
    ...
    search_space = {
        'seedid': range(2),
        'grill_variant.algo_kwargs.rl_offpolicy_num_training_steps': [0, 10, 100, 1000, 10000],
