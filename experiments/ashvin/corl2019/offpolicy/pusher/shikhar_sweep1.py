...
if __name__ == "__main__":
    variant = dict(
        ...
        grill_variant=dict(
            ...
            vae_path="datasets/shikhar_pusher2/vae.pkl",
        ),
    ...
    search_space = {
        'seedid': range(10),
        'grill_variant.exploration_noise': [0.2, 0.5, 0.8],
    ...
    run_variants(grill_her_td3_online_vae_full_experiment, variants, run_id=1)
