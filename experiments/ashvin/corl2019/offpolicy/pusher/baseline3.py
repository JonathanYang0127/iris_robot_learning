...
if __name__ == "__main__":
    variant = dict(
        ...
        env_kwargs=dict(
            ...
            hand_goal_high=[0.04999999999999999, 0.6499999999999999],
            hand_goal_low=[-0.04999999999999999, 0.55],
            mocap_high=[0.1, 0.7, 0.5],
            mocap_low=[-0.1, 0.5, 0.0],
            object_high=[0.2, 0.7, 0.02],
            object_low=[-0.2, 0.5, 0.02],
        ...
        grill_variant=dict(
            ...
            algo_kwargs=dict(
                ...
                dataset_path="datasets/pusher_color_spectrum/pusher_spectrum.npy",
    ...
    search_space = {
        'seedid': range(5),
        'grill_variant.algo_kwargs.rl_offpolicy_num_training_steps': [0],
        'grill_variant.algo_kwargs.dataset_path': [None],
