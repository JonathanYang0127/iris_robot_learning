...
if __name__ == "__main__":
    ...
    search_space = {
        'seedid': range(3),
        'grill_variant.exploration_noise': [0.2, 0.5, 0.3],
        'grill_variant.algo_kwargs.num_trains_per_train_loop':[10, 100, 1000, 1500],
    }
    ...
    run_variants(grill_her_td3_online_vae_full_experiment, variants, run_id=3)
