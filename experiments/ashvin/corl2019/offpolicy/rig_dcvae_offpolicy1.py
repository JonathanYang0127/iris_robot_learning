    ...
    variant = dict(
        ...
        grill_variant=dict(
            ...
            algo_kwargs=dict(
                ...
                dataset_path="datasets/Multiobj2DEnv_N100000_sawyer_pusher_camera_upright_v2_imsize48_random_oracle_split_0offpolicy.npy",
            ),
            ...
            vae_path="ashvin/corl2019/offpolicy/dcvae1/run0/id0/itr_800.pkl",
        ),
