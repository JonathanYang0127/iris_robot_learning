...
if __name__ == "__main__":
    variant = dict(
        ...
        env_kwargs=dict(
            goal_low=(-.05, .635,  .225, 0.0), # (-0.1, 0.45, 0.1, 0),
            goal_high=(-.05, .635,  .225, 0.83), # (0.05, 0.65, .25, .83),
...
#                dynamics_type='local',
    ...
    search_space = {
        ...
        'train_vae_variant.generate_vae_dataset_kwargs.n_random_steps': [101],#, 50, 100],
    }
