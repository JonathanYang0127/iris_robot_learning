...
top_drawer_goals = 'sasha/affordances/goals/affordances_top_drawer_goals.pkl'
bottom_drawer_goals = 'sasha/affordances/goals/affordances_bottom_drawer_goals.pkl'
tray_goals = 'sasha/affordances/goals/affordances_tray_goals.pkl'
obj_goals = 'sasha/affordances/goals/affordances_obj_goals.pkl'
if __name__ == "__main__":
    variant = dict(
        ...
        pretrained_vae_path="ashvin/icra2021/val/onecolor1/run20/id20/best_vqvae.pt",
    )
    search_space = {
        "seed": range(1),
        'path_loader_kwargs.demo_paths': [demo_paths],
        'env_kwargs.env_type': ['top_drawer', 'bottom_drawer', 'tray', 'obj'], #HERE
        'reward_kwargs.epsilon': [2, 3, 4, 5, 6, 7],
    ...
    variants = []
    GOALS = dict(tray=tray_goals, top_drawer=top_drawer_goals, bottom_drawer=bottom_drawer_goals, obj=obj_goals)
