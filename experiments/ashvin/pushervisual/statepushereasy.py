...
from multiworld.envs.mujoco.sawyer_xyz.sawyer_push_nips import SawyerPushAndReachXYFlexibleEnv
...
if __name__ == "__main__":
    ...
    variant = dict(
        ...
        env_class=SawyerPushAndReachXYFlexibleEnv,
        env_kwargs=dict(
            x_size=0.1,
            y_size=0.1,
            hide_goal=True,
    ...
    search_space = {
        ...
        'env_kwargs.x_size': [0.1, 0.2],
        'env_kwargs.y_size': [0.1, 0.2],
    }
