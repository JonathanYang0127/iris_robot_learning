...
if __name__ == "__main__":
    ...
    search_space = {
        'seedid': range(5),
        'grill_variant.algo_kwargs.base_kwargs.num_updates_per_env_step': [16, ],
        ...
        'grill_variant.algo_kwargs.base_kwargs.bc_weight': [0.0],
        'grill_variant.algo_kwargs.base_kwargs.rl_weight': [1.0],
