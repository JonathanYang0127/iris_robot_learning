...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'grill_variant.vae_path': [
            'shikhar/corl2019/multiobj-cvae/run0/id0/vae.pkl',
            'shikhar/corl2019/multiobj-cvae/run0/id1/vae.pkl',
            'shikhar/corl2019/multiobj-cvae/run0/id2/vae.pkl',
			'shikhar/corl2019/multiobj-cvae/run0/id3/vae.pkl',
			'shikhar/corl2019/multiobj-cvae/run0/id4/vae.pkl',
        ]
    }
