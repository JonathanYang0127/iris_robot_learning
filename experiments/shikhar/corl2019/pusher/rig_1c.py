...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'grill_variant.vae_path': [
            'shikhar/corl2019/mulitobj-cvae/multiobj-cvae-new-p/run5/id0/vae.pkl',
            'shikhar/corl2019/mulitobj-cvae/multiobj-cvae-new-p/run5/id1/vae.pkl',
            'shikhar/corl2019/mulitobj-cvae/multiobj-cvae-new-p/run5/id2/vae.pkl',
            'shikhar/corl2019/mulitobj-cvae/multiobj-cvae-new-p/run5/id3/vae.pkl',
        ]
    }
