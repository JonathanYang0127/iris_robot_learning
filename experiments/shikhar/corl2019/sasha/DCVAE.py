...
if __name__ == "__main__":
    variant = dict(
        ...
        env_kwargs=dict(
            ...
            maxlen=0.1,
            action_repeat=5,
            object_meshes=['Bowl', 'GlassBowl', 'LotusBowl01', 'ElephantBowl'],
        ...
        train_vae_variant=dict(
            ...
            generate_vae_dataset_kwargs=dict(
                dataset_path="/tmp/SawyerMultiobjectEnv_N20000_sawyer_init_camera_zoomed_in_imsize48_random_oracle_split_0.npy",#"/home/khazatsky/rail/data/multiobj_two_puck.npy",
                N=20000,
                n_random_steps=5000,
                test_p=.9,
                use_cached=True,
...
#                dynamics_type='local',
    ...
    search_space = {
        'seedid': range(1),
        'train_vae_variant.representation_size': [(12, 20),], #(3 * objects, 3 * colors)
