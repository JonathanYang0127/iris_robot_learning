...
from rlkit.torch.vae.conditional_conv_vae import CDVAE, CVAE
from rlkit.torch.vae.vae_trainer import CDVAETrainer, CVAETrainer
...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'train_vae_variant.beta': [50, 20, 10], #THIS IS A LINEAR INTERPOLATION CURRENTLY
