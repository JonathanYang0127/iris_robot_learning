...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'grill_variant.vae_path': [
            ...
            'shikhar/corl2019/multiobj-cvae-imsize-large/run0/id3/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-imsize-large/run0/id4/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-imsize-large/run0/id5/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-imsize-large/run0/id6/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-sweep-beta/run1/id0/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-sweep-beta/run1/id1/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-sweep-beta/run1/id2/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-sweep-beta/run1/id3/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-sweep-beta/run1/id4/vae.pkl',
            'shikhar/corl2019/multiobj-cvae-sweep-beta/run1/id5/vae.pkl',
        ]
    }
