...
demo_paths=[dict(path='sasha/complex_obj/gr_train_complex_obj_demos_0.pkl', obs_dict=True, is_demo=True),
...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'env_kwargs.quat_dict': [{}],
        'env_kwargs.randomize': [True],
        
        'env_kwargs.use_bounding_box': [True],
        'env_kwargs.object_subset': [['mug'], ['beer_bottle'], ['camera'], ['long_sofa']],
    ...
    EVAL_GOALS = {'mug': mug_goals, 'beer_bottle': beer_bottle_goals, 'camera': camera_goals, 'long_sofa': long_sofa_goals}
    EXPL_GOALS = {'mug': 'sasha/presampled_goals/pixelcnn_mug_goals.pkl', 
                'beer_bottle': 'sasha/presampled_goals/pixelcnn_beer_bottle_goals.pkl',
                'camera': 'sasha/presampled_goals/pixelcnn_camera_goals.pkl',
                'long_sofa': 'sasha/presampled_goals/pixelcnn_long_sofa_goals.pkl'}

    for variant in sweeper.iterate_hyperparameters():
        curr_obj = variant["env_kwargs"]["object_subset"][0]
        variant["presampled_goal_kwargs"]["eval_goals"] = EVAL_GOALS[curr_obj]
        variant["presampled_goal_kwargs"]["expl_goals"] = EXPL_GOALS[curr_obj]
        variants.append(variant)

    run_variants(awac_rig_experiment, variants, run_id=51) #HERE