...
demo_paths=[dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_0.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_1.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_2.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_3.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_4.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_5.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_6.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/tray/gr_multiobj_tray_demos_7.pkl', obs_dict=True, is_demo=True)]

image_train_data = 'sasha/affordances/tray/gr_multiobj_tray_images.npy'
image_test_data = 'sasha/affordances/tray/gr_multiobj_tray_test_images.npy'
tray_goals = 'sasha/presampled_goals/affordances/tray/gr_multiobj_tray_goals.pkl'
vqvae = 'sasha/affordances/tray/best_vqvae.pt'
...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'reward_kwargs.epsilon': [2, 3, 4, 5, 6, 7, 8],
...
######### CHANGE TABLE COLOR BACK!!!!!
    run_variants(awac_rig_experiment, variants, run_id=13) #HERE