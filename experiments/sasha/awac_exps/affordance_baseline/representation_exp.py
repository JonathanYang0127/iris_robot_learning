...
vqvae = 'sasha/models/vqvae/best_vqvae.pt'
...
if __name__ == "__main__":
    variant = dict(
        ...
        path_loader_class=DuelEncoderDictToMDPPathLoader,
    ...
    search_space = {
        ...
        'input_model_path': [
            'sasha/models/vae/bottom_itr_1500.pt',
            'sasha/models/ccvae/bottom_itr_1500.pt',
            'sasha/models/bigan/bottom_itr_1500.pt', # THIS DOESNT EXIST YET!!!!!!!!!
            'sasha/models/cbigan/bottom_itr_1500.pt', # THIS DOESNT EXIST YET!!!!!!!!!
            ],
    ...
    run_variants(duel_awac_rig_experiment, variants, run_id=1)