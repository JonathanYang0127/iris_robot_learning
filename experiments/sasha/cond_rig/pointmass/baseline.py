...
from rlkit.torch.vae.conditional_conv_vae import ConvVAE
...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'train_vae_variant.representation_size': [4,], #(3 * objects, 3 * colors)
        'train_vae_variant.beta': [20],
        'train_vae_variant.generate_vae_dataset_kwargs.n_random_steps': [100],
        'grill_variant.vae_path': ["/home/khazatsky/rail/data/rail-khazatsky/sasha/pointmass/GVAE/run50/id0/itr_500.pkl"]
    }
