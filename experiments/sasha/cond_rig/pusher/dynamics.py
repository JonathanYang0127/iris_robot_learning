...
=======
        init_camera=multiworld.envs.mujoco.cameras.sawyer_pusher_camera_upright_v2,
...
>>>>>>> d9a863b950966a9a323435b992b460df143449a9
        ...
        grill_variant=dict(
            ...
            vae_path="/home/khazatsky/rail/data/rail-khazatsky/sasha/pusher_vaes/1/vae.pkl",
        ),
    ...
    search_space = {
        ...
        'train_vae_variant.representation_size': [(6, 2),], #(3 * objects, 3 * colors)
    ...
    run_variants(grill_her_twin_sac_online_vae_full_experiment, variants, run_id=15)