...
from rlkit.torch.vae.conditional_conv_vae import DeltaDynamicsCVAE
from rlkit.torch.vae.vae_trainer import DeltaDynamicsCVAETrainer
...
if __name__ == "__main__":
    variant = dict(
        ...
        env_kwargs=dict(
            ...
            maxlen=0.1,
            action_repeat=5,
            object_meshes=None,#['Bowl', 'GlassBowl', 'LotusBowl01', 'ElephantBowl', 'RuggedBowl', 'Fork'],
            ...
            # mocap_high=(0.2, 0.7, 0.5),
            # mocap_low=(-0.2, 0.5, 0.0),
            # object_high=(0.1, 0.65, 0.02),
            # object_low=(-0.1, 0.55, 0.02),
        ...
        train_vae_variant=dict(
            ...
            generate_vae_dataset_kwargs=dict(
                dataset_path="/tmp/SawyerMultiobjectEnv_N100000_sawyer_init_camera_zoomed_in_imsize48_random_oracle_split_0.npy",
                N=100000,
                n_random_steps=5000,
                test_p=.9,
                use_cached=False,
            ...
            vae_trainer_class=DeltaDynamicsCVAETrainer,
            vae_class=DeltaDynamicsCVAE,
            vae_kwargs=dict(
                dynamics_type='local',
                input_channels=3,
    ...
    search_space = {
        ...
        'train_vae_variant.algo_kwargs.linearity_weight':[10,],
