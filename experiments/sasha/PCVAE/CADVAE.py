...
from rlkit.torch.vae.conditional_conv_vae import CADVAE
from rlkit.torch.vae.vae_trainer import CADVAETrainer
...
if __name__ == "__main__":
    variant = dict(
        ...
        train_vae_variant=dict(
            ...
            vae_trainer_class=CADVAETrainer,
            vae_class=CADVAE,
            vae_kwargs=dict(
                dynamics_type='local',
                input_channels=3,
    ...
    search_space = {
        ...
        'train_vae_variant.generate_vae_dataset_kwargs.N': [100000],#, 50, 100],
    }
    ...
    run_variants(experiment, variants, run_id=1002)