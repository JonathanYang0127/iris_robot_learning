...
from rlkit.torch.vae.conditional_conv_vae import DeltaCVAE, CVAE, ConvVAE
from rlkit.torch.vae.vae_trainer import DeltaCVAETrainer, CVAETrainer, ConvVAETrainer
...
#                dynamics_type='local',
    ...
    search_space = {
        'seedid': range(1),
        'train_vae_variant.representation_size': [5,], #(3 * objects, 3 * colors)
        'train_vae_variant.generate_vae_dataset_kwargs.n_random_steps': [50],#, 50, 100],
    }
