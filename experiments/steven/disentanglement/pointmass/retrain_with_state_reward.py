...
if __name__ == "__main__":
    variant = dict(
        transfer_variant=dict(
            train_encoder_as_vae=False,
            encoder_backprop_settings='rl',
    ...
    search_space = {
        ...
        'train_variant.pretrain_vae': [True],
    ...
    n_seeds = 4
    mode = 'local'
    exp_name = 'two-object-init-on-object-retrain-state-reward'
