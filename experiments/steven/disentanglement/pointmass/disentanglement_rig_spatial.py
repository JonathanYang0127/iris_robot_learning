...
if __name__ == "__main__":
    variant = dict(
        ...
        # use_special_qf_architecture=False,
        latent_dim=2,
        vae_n_vae_training_kwargs=dict(
            ...
            vae_train_epochs=200,
            num_image_examples=40000,
            vae_architecture=imsize48_default_architecture_spatial,
        ),
        # vae_path='03-05-pointmass-spatial-vae-disentangelement-comp-again-latent-2-longer/03-05-pointmass-spatial-vae-disentangelement-comp-again-latent-2-longer_2020_03_05_21_02_05_id000--s81582/vae.pkl',
        save_video=True,
    ...
    n_seeds = 2
    mode = 'local'
    exp_prefix = 'pointmass-spatial-vae-test-good-repr-vectorized'
